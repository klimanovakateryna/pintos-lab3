...
bool less(struct list_elem *wr1, struct list_elem *wr2) {
  // get the structs with data
  struct mystruct *word1 = list_entry(wr1, struct mystruct, elem);
  struct mystruct *word2 = list_entry(wr2, struct mystruct, elem);
  int compare = strcmp(word1->word, word2->word);
